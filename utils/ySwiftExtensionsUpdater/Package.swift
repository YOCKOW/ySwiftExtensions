...
let package = Package(
  ...
  products: [
    ...
    .library(name: "ySwiftExtensionsUpdater", targets: ["yExtensionsUpdater"]),
  ...
  dependencies: [
    ...
    .package(url: "https://github.com/YOCKOW/ySwiftCodeUpdater.git", from: "2.0.0"),
