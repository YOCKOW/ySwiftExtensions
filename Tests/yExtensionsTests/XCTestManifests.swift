...
extension StringProtocolCountTests {
    // DO NOT MODIFY: This is autogenerated, use:
    //   `swift test --generate-linuxmain`
    // to regenerate.
    static let __allTests__StringProtocolCountTests = [
        ("test_countComparison", test_countComparison),
    ]
}
...
public func __allTests() -> [XCTestCaseEntry] {
    return [
        ...
        testCase(StringProtocolCountTests.__allTests__StringProtocolCountTests),
